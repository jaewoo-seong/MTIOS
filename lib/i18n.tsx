...
const ko: Record<string, string> = {
  ...
  ,"Campaigns": "캠페인"
  ,"Collection Campaigns": "수집 캠페인"
  ,"Multi-entity research, its reports, and mid-flight steering": "다중 대상 조사, 보고서 및 진행 중 방향 조정"
  ,"Steer a running campaign, raise its ceiling, or continue what is still pending.": "진행 중인 캠페인의 방향을 조정하거나 상한을 올리거나 남은 작업을 이어서 진행하세요."
  ,"Refocus the search": "검색 방향 변경"
  ,"Continue campaign": "캠페인 계속"
  ,"Review reports": "보고서 검토"
